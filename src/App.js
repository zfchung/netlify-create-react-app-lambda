        ...
        <main className="App-main App-padding">
          <article>
            ...
            <p>
              <ul>
                <li>
                  Breaking code down to smaller components/factors, and then
                  being able to use those smaller components in an easier way.
                </li>
                <li>
                  Allow you to make changes with zero impact on user, the api,
                  the behaviour of your system. It will only change the
                  internals.
                </li>
              </ul>
            ...
            <p>
              <ul>
                ...
                <li>
                  The beauty of software, unlike other mediums, is that it is
                  able to evolve as user needs changes.
                </li>
                <li>
                  Software is no longer be able to evolve, when it becomes like
                  a rusty screw with nut: "Tightly Coupled", "Rusted", "Corodded
                  over time"
                </li>
              </ul>
            </p>
            ...
            <p>
              <ul>
                <li>
                  When you only refactor when things went terribly wrong or
                  until there is a palpable sense of inefficiency in our code
                  base that you feel that you need to refactor to get our days,
                  weeks back in our life.
                </li>
                <li>There are no good choices when you got to that point</li>
                <li>TDD means that you are refactoring daily, hourly</li>
                <li>
                  We are constantly re-evaluating the design of our code and
            ...
            <h3>Goals fo Refactoring</h3>
            <p>
              <ul>
                <li>
                  We're on the job, we have a professional responsibility to set
                  a goal of this refactoring exercise.
                </li>
                <li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li>
                          ...
                          code works. Because it may lie to you if you do not
                          have automated feedback on what it claims it does.
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          "What is this person thinking". Exactly, we do not
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          Remove elements that are not following the above 3
                          rules
                        </li>
                      </ul>
                    </li>
